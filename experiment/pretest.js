...
d: "A node in a binary tree can have two or more children ", ///// Write the option 2 inside double quotes
},
...
{
question: "4. In a binary search tree all nodes in the left subtree are __________. ",  ///// Write the question inside double quotes
answers: {
a: "SMALLER than the root ",                  ///// Write the option 1 inside double quotes
b: "GREATER than the root ",                  ///// Write the option 2 inside double quotes
c: "EQUAL to the root ", ///// Write the option 3 inside double quotes

},
correctAnswer: "a"                ///// Write the correct option inside double quotes
},
{
question: "5. What is the worst case height possible in a binary search tree? Let N be the number of nodes in the tree. ",  ///// Write the question inside double quotes
answers: {
